#!/usr/bin/env python3
"""
ROS 2 — Confusion ("I didn't understand")
Tilted head, asymmetric ears, neutral still arms.
"""
...
class ConfusionDemo(Node):
    def __init__(self,
        ...
        self.left_arm_base = [-1.0, 0.6, 1.2, -1.2, 0.0, 0.0, 1.0]
        self.right_arm_base = [-1.0, 0.6, 1.2, -1.2, 0.0, 0.0, 1.0]
        ...
        self.get_logger().info('Confusione avviata: testa inclinata, orecchie asimmetriche, braccia neutre, per 6s')
	...
	# self.face_pub.publish(face_msg)
        ...
        if elapsed > self.duration:
            self.get_logger().info('Confusione completata. Nodo in standby.')
