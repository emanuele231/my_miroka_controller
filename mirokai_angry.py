#!/usr/bin/env python3
"""
ROS 2 — Anger (hands on hips, ears tense (middle position)
"""
...
class AngerDemo(Node):
    def __init__(self,
        ...
        self.get_logger().info('Rabbia avviata: mani sui fianchi ferme, orecchie tese, per 6s')

    def _on_pointcloud(self, msg: PointCloud2) -> None:
        pass

    def publish_anger_stream(self) -> None:
	...
	# self.face_pub.publish(face_msg)
        ...
        if elapsed > self.duration:
            self.get_logger().info('Rabbia completata. Nodo in standby.')
            self.timer.cancel()
            return
